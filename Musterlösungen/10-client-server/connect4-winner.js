//
//  CONNECT4 WINNER –– FUNCTIONAL APPROACH
//  Find out if connect4 game has a winner
//  Gerrit Burkert 2022, Update 2023
//  
//  To do:
...
const hasSubSeq = curry3((n, el, seq) => (
...
const connect4Winner = (el, board) =>
	some(board, hasSubSeq(4)(el))
	|| some(columns(board), hasSubSeq(4)(el))
	|| some(columns(shift2d(board, null, false)), hasSubSeq(4)(el))
	|| some(columns(shift2d(board, null, true)), hasSubSeq(4)(el))
